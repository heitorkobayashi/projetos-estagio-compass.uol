...
A primeira forma normal 1FN já estava realizada, então bastou atentar-se para as formas seguintes, 2FN e 3FN. Para facilitar a visualização desses dados, nesse primeiro momento, optei pela utilização do [`dbdiagram.io`](https://dbdiagram.io/), como mostra a imagem a seguir:
